...
public class ProjectExplorerPresenter extends BasePresenter implements ActionDelegate,
    ...
    private final Provider<VcsBranchPresenterProvider> vcsBranchPresenterProvider;
    ...
    public ProjectExplorerPresenter(ProjectExplorerView view,
                                    ...
                                    Provider<VcsBranchPresenterProvider> vcsBranchPresenterProvider,
        ...
        this.vcsBranchPresenterProvider = vcsBranchPresenterProvider;
    ...
    public void onVcsBranchClicked(Project project) {
        vcsBranchPresenterProvider.get().show(project);
    }
